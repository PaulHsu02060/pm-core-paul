...
- **settings.js**（低）：9920–10425（PAGE SETTINGS＋SECURITY_INFO）＋10426–10493（cloud sync handlers）＋backupAll/restoreAll/clearAll（11723–11769 挖入）。
- **meeting.js**（低）：8273–8487（OCR 截圖 handleShotUpload/runOCR/confirmOCRMeetings）＋10494–10872（meeting template helpers）。
